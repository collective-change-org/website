...
export const BecomeMember: Component<Props> = (props) => {
	...
	const [success, setSuccess] = createSignal<boolean>(true)
			...
			<Dialog>
				...
				<Dialog.Portal>
					...
					<Dialog.Content
						...
						<Show when={!success()} fallback={<SuccessScreen />}>
...
const SuccessScreen: Component = () => {
	return (
		<>
			<h2>Wilkommen im Kollektiv!</h2>
			<div class="mt-3 flex justify-between gap-2">
				<Dialog.Close class="rounded-md bg-indigo-700 px-3 py-2 cursor-pointer hover:bg-indigo-600 w-full">
					Cool! Weiter gehts!
				</Dialog.Close>
			</div>
		</>
